...
<a href="javascript:;" style="text-decoration:none; color:#333; border-bottom:1px dashed #333;" data-toggle="modal" onclick="$('#addMenuPageModal').width(270).height(500).modal('show');" ><?php echo __('Add page', 'menu'); ?></a><br /><br />
