...
<div class="row">
    ...
    <?php
        ...
        if (isset($_SESSION['user_role']) && in_array($_SESSION['user_role'], array('admin'))) {        
            echo Form::label('login', __('Login', 'users'));
        ...
        if (isset($_SESSION['user_role']) && in_array($_SESSION['user_role'], array('admin'))) {        
            ...
            echo Form::select('role', array('admin' => __('Admin', 'users'),'user' => __('User', 'users'),'editor' => __('Editor', 'users')), $user['role'], array('class' => 'span3')). Html::br();
        } else {        
    ...
    <?php
        ...
        echo (
            ...
            Form::label('old_password', __('Old password', 'users')).
